...
export interface PartyValidationError {
    ...
    // موكل المكتب") — بتتفلتر بـ partyId==='' في مكان العرض.
    partyId: string;
    field: 'name' | 'capacity' | 'national_id';
    message: string;
}
 ...
 * القواعد بالترتيب (قسم 4 من الخطة):
 ...
 */
export function validateParties(parties: PartyFieldValue[]): PartiesValidationResult {
